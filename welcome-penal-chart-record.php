...
<title>WELCOME PENAL PANEL CHART RECORD MATKA BAZAR</title> <meta name="description" content="WELCOME MATKA PENAL PANEL CHART RECORD PANNA PATTI 
...
<link rel="canonical" href="https://dpboss.boston/welcome-penal-chart-record.php"/>
...
<div class="panel-heading text-center" style="background: #3f51b5;"><h1  style="font-size: 22px;color:#fff; text-shadow: 0px 0px;">Welcome Panel Chart </h1></div>
...
<?php 
include 'config.php';
$gh = mysqli_query($con,"SELECT * FROM panel where gameName = 'WELCOME' ORDER BY id ");
