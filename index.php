...
.m-icon {
  ...
  box-shadow: inset 0 0 5px #ff00ff, 0 0 10px 1px rgba(233, 30, 99, 0.55) !important;
...
.f-pti h3:first-of-type {
  ...
  /* stretch to card edges like screenshot */
  margin: -3px -3px 6px -3px !important; /* negate .f-pti padding */
  ...
  text-align: center !important;
  font-style: italic !important;
  padding: 8px 6px !important; /* more height */
...
/* Footer bottom (Powered by + copyright/links) */
.pow-13,
.lst-sec[role="contentinfo"] {
...
.lst-sec[role="contentinfo"],
.lst-sec[role="contentinfo"] p,
.lst-sec[role="contentinfo"] h2,
.lst-sec[role="contentinfo"] h3,
.lst-sec[role="contentinfo"] a {
  color: #000 !important;
  text-shadow: none !important;
}
.lst-sec[role="contentinfo"] p,
...
/* Weekly sections (sun-col): force white background */
.sun-col,
.sun-col > div {
...
/* FREE GAME ZONE OPEN-CLOSE boxes: match TOP-GUSSER style */
.oc-fg .d1635 {
...
/* draw grid lines without cutting corners */
.oc-fg .d1635 > .oc-3a-69 {
  box-shadow: inset 0 0 0 1px #000 !important;
}
.oc-fg .d1635 > .oc-3a-69:nth-child(odd) {
  box-shadow: inset -1px 0 0 #000, inset 0 0 0 1px #000 !important; /* vertical divider */
}
/* header (market name) */
.oc-fg .oc-3a-69 .g5a1 {
...
.oc-fg .d1635 > .oc-3a-69:nth-child(odd) .l9w2v { background-color: green !important; }
.oc-fg .d1635 > .oc-3a-69:nth-child(even) .l9w2v { background-color: #00f !important; }
...
.liv-rslt {
  ...
  border-radius: 8px !important;
  overflow: hidden !important; /* join heading + list */
}
.liv-rslt h4 {
  color: #000 !important;
  padding: 16px 5px !important; /* more height */
  margin: 0 !important; /* no separate gap */
  text-align: center !important;
  font-weight: 700 !important;
  ...
  font-size: 0 !important; /* keep original text hidden */
  background-color: #ffc107 !important;
  /* stretch to card edges like screenshot */
  margin: -3px -3px 0 -3px !important; /* negate common card padding */
  width: calc(100% + 6px) !important;
  box-sizing: border-box !important;
  box-sizing: border-box !important;
...
/* Keep .flyr24 (WORLD ME...) previous yellow style unchanged */
.flyr24 {
  background-color: #ffc107 !important;
  color: transparent !important; /* hide original text/icons (e.g., umbrellas) */
  font-weight: 700 !important;
  font-size: 0 !important; /* prevent ghost text */
  font-family: "Open Sans", Arial, sans-serif !important;
  border: 3px solid orange !important;
  margin: 0 0 5px !important; /* no left/right overrun */
  text-shadow: none !important; /* prevent ghost text-shadow */
  border-radius: 4px !important;
  text-align: center !important;
  font-style: italic !important;
...
.flyr24::after {
  content: "❰❰❰ 📶  LIVE MATKA RESULT  ❱❱❱" !important;
  color: #000 !important;
  text-shadow: 1px 1px #d8b947 !important;
  font-size: 20px !important;
...
/* 1st heading: Live Results + news.gif */
.liv-rslt h4::after {
  content: "📡 Live Results" !important;
  color: #000 !important;
  text-shadow: 1px 1px #d8b947 !important;
  font-size: 20px !important;
  line-height: 1.2 !important;
  ...
  background-size: 28px 28px !important; /* slightly bigger NEW icon */
...
.tkt-val > div {
  ...
  border-radius: 0 !important;
  margin: 0 !important;
  padding: 18px 6px 16px !important; /* top space for corner buttons */
  border-bottom: 1px solid #d9d9d9 !important; /* row separator */
  position: relative !important;
}
.tkt-val > div.bg-ylw {
...
.tkt-val > div:last-child { border-bottom: 0 !important; }
...
.tkt-val h4 {
  ...
  padding: 0 !important;
  color: #ff0000 !important; /* default; overridden below */
  font-size: 20px !important;
  font-style: italic !important;
  font-weight: 900 !important;
  text-shadow: 1px 2px 0 #ffffff, 0 3px 8px rgba(0,0,0,0.18) !important;
}
.tkt-val > div:nth-child(4n + 1) > h4 { color: #0a8a00 !important; } /* green */
.tkt-val > div:nth-child(4n + 2) > h4 { color: #7b1fa2 !important; } /* purple */
.tkt-val > div:nth-child(4n + 3) > h4 { color: #d50000 !important; } /* red */
.tkt-val > div:nth-child(4n) > h4 { color: #0d47a1 !important; }     /* blue */
.tkt-val span {
  display: block !important;
  ...
  font-style: italic !important;
  font-weight: 900 !important;
  text-shadow: 1px 2px 0 #ffffff, 0 3px 10px rgba(0,0,0,0.12) !important;
  background: transparent !important;
...
.tkt-val p::before { content: "("; }
.tkt-val p::after { content: ")"; }
/* Place buttons: Jodi left, Panel right (like original) */
.tkt-val .vl-clk,
.tkt-val .vl-clk-2 {
  position: absolute !important;
  top: 14px !important; /* little top margin */
...
.tkt-val .vl-clk { left: 10px !important; right: auto !important; }
.tkt-val .vl-clk-2 { right: 10px !important; left: auto !important; }
...
/* Dpboss Special Game Zone (and similar .sky-23 headings) */
.sky-23 > h4 {
  background-color: purple !important;
  color: #ff0 !important;
  border-width: 3px !important;
...
/* Links inside "Dpboss Special Game Zone" boxes */
.sky-23 {
  background-color: #fff !important;
  background: #fff !important;
}
.sky-23 a {
  ...
  border-style: groove solid !important;
...
<img src='data:image/jpeg;base64,' alt="dpboss net LAXMI_PICTURE" width="90" height="68" />
  ...
  <div class="text2">
  <h1 style="font-size: 16px;color: #000;padding-bottom: 3px;">Satta Matka Dpboss.net Kalyan Matka Result</h1>
  <h2 style="color: #000;font-size: 10px;font-weight: 600;line-height: 11px;text-shadow: none;">DPBOSS.Service is the No. 1 Matka Sites welcomes you full-heartedly. Here below you can find the perfect guess by the top guesser along with the Fast Matka Result too.  Aaj Ka Satta Kalyan Fix Single Jodi free update here you find top Matka Market of India Kalyan Main Milan Rajdhani* *kalyan Matka Tips *fast Matka Result *kalyan Main Rajdhani Matka Chart *Matka Guessing by DPBOSS By App Best Matka Site By DPBOSS <?php 
...
<h3 style="margin-bottom: 2px;">Today Lucky Number</h3>
<div class="dflex">
...
<?php if(1){  ?>
  ...
  <a target="_blank" href="https://whatsapp.com/channel/0029VbCH7KEGpLHN8giIeL2F" rel="noopener noreferrer" style="color:#fff;border:2px solid #fff;padding:6px 0;display:block;width:230px;margin:6px auto;border-radius:15px;background:#b3007a;text-decoration:none;font-weight:600;">📲JoinOnWhatsapp</a></div>
...
?><div><span ><p class="tct3"><?php echo file_get_contents($adFile); ?></p></span></div>
<?php }} ?><div>
...
if($time1 >= $startTime && $time1 <= $endTime){
  if ($updateDate!=date('d-m-Y')) {
    ...
    ?> 
<div <?php if ($gameName=='KALYAN'||$gameName=='KALYAN NIGHT'||$gameName=='BOMBAY NIGHT'||$gameName=='OLD MAIN MUMBAI' || $gameName=='OLD BAZAR'||$gameName=='RATAN KHATRI'||$gameName=='KALYAN MORNING'|| $gameName=='MAIN BAZAR' || $gameName=='KUBER111' || $gameName=='KARNATAKA DAY' || $gameName=='MUMBAI DAY [MAIN]' || $gameName=='PRABHAT' || $gameName=='NIGHT KALYAN BAZAR'
...
<div class="eml-us">
  ...
  <a href="mailto:support@dpboss.net">support@dpboss.net</a></div>
</div>


<!-- Compact APK Download Section -->
<div style="max-width:600px;margin:15px auto;padding:15px;border-radius:12px;
background:#fff;box-shadow:0 3px 10px rgba(0,0,0,0.07);text-align:center;font-family:Arial, sans-serif;">

  <!-- Heading -->
  <h3 style="color:#f44646;font-size:18px;margin-bottom:8px;">
    📲 Play Matka on Mobile
  </h3>

  <!-- Short Content -->
  <p style="font-size:14px;color:#555;line-height:20px;margin-bottom:10px;">
  ...
  <div style="font-size:13px;color:#333;margin-bottom:12px;">
    ⚡ Fast Play • 💰 Easy Cash • 📊 Live Results
  </div>

  <!-- Button -->
  <a href="https://laksh365.com/downloads/Laksh365.apk"
     style="display:inline-block;background:#f44646;color:#fff;
...
<div class="text2" style="margin-bottom:7px;font-size:14px;padding:7px;line-height:25px;background:#c4001a;color:#f9f9f9;text-align:center;">
  ...
  <a target="_blank" href="https://dpboss.boston/dpboss-result-api.php" style="color:#fff;border:2px solid #fff;padding:6px 0;display:block;width:230px;margin:8px auto;border-radius:15px;background:#b3007a;text-decoration:none;font-weight:600;">
    🚀CheckApiPricing🚀</a>
    Realtime Update,100% Trusted Legacy<br>10X faster & 24/7 Support & Uptime</div>

<?php } ?>


<!-- Dpboss Special Game Zone --> 
<div class="sky-23"> <h4>Dpboss Special Game Zone</h4> 
...
foreach ($theData as $line) {
    $line = trim($line);
    if ($line == "") continue;
    list($order, $gameName, $gameResult, $timeOpen, $timeClose, $gameBgcolor,
         $gameFontcolor, $gameLinecolor, $frequency, $liveTimeBefore,
         $liveTimeAfter, $updateDate, $status, $expiryDate, $jodiLink,
         $panelLink, $temp_last_updated_result, $finalAnk)
        = explode("|", $line);
    if ($updateDate != $today) {
...
?><div><h4><?php echo $weekly[0] ?></h4><p>1=><?php echo $weekly[1]; ?></p><p>2=><?php echo $weekly[2]; ?></p><p>3=><?php echo $weekly[3]; ?></p><p>4=><?php echo $weekly[4]; ?></p><p>5=><?php echo $weekly[5]; ?></p><p>6=><?php echo $weekly[6]; ?></p><p>7=><?php echo $weekly[7]; ?></p><p>8=><?php echo $weekly[8]; ?></p><p>9=><?php echo $weekly[9]; ?></p><p>0=><?php echo $weekly[10]; ?></p></div><!--  --><div>
    <h4><?php echo $weekly[11]; ?></h4><p>Mon. <?php echo $weekly[12]; ?> </p><p>Tue. <?php echo $weekly[13]; ?></p><p>Wed. <?php echo $weekly[14]; ?></p><p>Thu. <?php echo $weekly[15]; ?></p><p>Fri. <?php echo $weekly[16]; ?></p><p>Sat. <?php echo $weekly[17]; ?></p><p>Sun. <?php echo $weekly[18]; ?></p></div><!--  --><div><h4><?php echo $weekly[19]; ?></h4><p><?php echo $weekly[20]; ?></p><p><?php echo $weekly[21]; ?></p><p><?php echo $weekly[22]; ?></p><p><?php echo $weekly[23]; ?></p><p><?php echo $weekly[24]; ?></p><p><?php echo $weekly[25]; ?></p></div><!--  --></div>
<?php 
...
?>
<tr><td rowspan="2" class="v5a25-v4a5"><?php echo $days[$i];?></td>
...
<h6 class="pow-13">POWERD BY dpboss.boston</h6>
<div class="lst-sec" role="contentinfo">
<p>
&copy; 2011 - <?php echo date('Y');?> dpboss.boston <br> 
    ...
    | <a href="https://dpboss.boston/tos.php">Term And Conditions</a> | <a href="https://dpboss.boston/dpboss-result-api.php">Result Api</a>
