...
<head>
   ...
   <title>BK BAZAR PANEL CHART RECORD MATKA BAZAR</title>
   <meta name="description" content="BK BAZAR PANEL CHART RECORD PATTI PANNA BAZAR 
PATTA BK BAZARI CHART BK BAZAR OLD CHART RECORD BK BAZAR RESULTS RECORD BK BAZAR MATKA RECORD BK BAZAR MATKA TIPS CHART BK BAZAR HISTORY CHART BK BAZAR PANNA CHART BK BAZAR PATTI PATTA CHART ONLINE LIVE 
FIX NUMBER BK BAZAR MATKA RECORD CHART BOOK" />
   <meta http-equiv="X-UA-Compatible" content="IE=edge">
   <meta name="viewport" content="width=device-width, initial-scale=1">
   <link rel="canonical" href="https://dpboss.boston/panel-chart-record/bk-bazar.php">
      ...
      <div>
         <div class="panel panel-info">
            <div class="panel-heading text-center" style="background: #3f51b5;">
               <h1 style="font-size: 22px;color:#fff; text-shadow: 0px 0px;">BK BAZAR PANEL CHART </h1>
            </div>
            <div class="panel-body">
               <table style="width: 100%; text-align:center;" class="panel-chart chart-table" cellpadding="2">
                  ...
                  <tbody>
                     ...
                     <?php
                     include '../config.php';
                     $gh = mysqli_query($con, "SELECT * FROM panel where gameName = 'BK BAZAR' ORDER BY id ");
