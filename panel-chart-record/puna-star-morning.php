...
<head>
   ...
   <title>PUNA STAR MORNING PANEL CHART RECORD MATKA BAZAR</title>
   <meta name="description" content="PUNA STAR MORNING PANEL CHART RECORD PATTI PANNA BAZAR 
PATTA PUNA STAR MORNING I CHART PUNA STAR MORNING OLD CHART RECORD PUNA STAR MORNING RESULTS RECORD PUNA STAR MORNING MATKA RECORD PUNA STAR MORNING MATKA TIPS CHART PUNA STAR MORNING HISTORY CHART PUNA STAR MORNING PANNA CHART PUNA STAR MORNING PATTI PATTA CHART ONLINE LIVE 
FIX NUMBER PUNA STAR MORNING MATKA RECORD CHART BOOK" />
      ...
      <div>
         <div class="panel panel-info">
            <div class="panel-heading text-center" style="background: #3f51b5;">
               <h1 style="font-size: 22px;color:#fff; text-shadow: 0px 0px;">PUNA STAR MORNING PANEL CHART </h1>
            </div>
...
<tr>
   <td>22/09/2024<br>to<br>29/09/2024</td>
   <td class="">1<br>4<br>6</td>
   <td class="">17</td>
...
<tr>
   ...
   <td class="">6<br>8<br>0</td>
                     ...
                     $gh = mysqli_query($con, "SELECT * FROM panel where gameName = 'PUNA STAR MORNING' ORDER BY id ");
