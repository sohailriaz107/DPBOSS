...
<head>
   ...
   <title>LOKSEVA DAY PANEL CHART RECORD MATKA BAZAR</title>
   <meta name="description" content="LOKSEVA DAY PANEL CHART RECORD PATTI PANNA BAZAR 
PATTA LOKSEVA DAY I CHART LOKSEVA DAY OLD CHART RECORD LOKSEVA DAY RESULTS RECORD LOKSEVA DAY MATKA RECORD LOKSEVA DAY MATKA TIPS CHART LOKSEVA DAY HISTORY CHART LOKSEVA DAY PANNA CHART LOKSEVA DAY PATTI PATTA CHART ONLINE LIVE 
FIX NUMBER LOKSEVA DAY MATKA RECORD CHART BOOK" />
      ...
      <div>
         <div class="panel panel-info">
            <div class="panel-heading text-center" style="background: #3f51b5;">
               <h1 style="font-size: 22px;color:#fff; text-shadow: 0px 0px;">LOKSEVA DAY PANEL CHART </h1>
            </div>
...
<tr>
        ...
        <td>5<br>8<br>0</td>
                     ...
                     $gh = mysqli_query($con, "SELECT * FROM panel where gameName = 'LOKSEVA DAY' ORDER BY id ");
