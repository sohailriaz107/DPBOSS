...
<head>
   ...
   <title>GEETA MORNING PANEL CHART RECORD MATKA BAZAR</title>
   <meta name="description" content="GEETA MORNING PANEL CHART RECORD PATTI PANNA BAZAR 
PATTA GEETA MORNING I CHART GEETA MORNING OLD CHART RECORD GEETA MORNING RESULTS RECORD GEETA MORNING MATKA RECORD GEETA MORNING MATKA TIPS CHART GEETA MORNING HISTORY CHART GEETA MORNING PANNA CHART GEETA MORNING PATTI PATTA CHART ONLINE LIVE 
FIX NUMBER GEETA MORNING MATKA RECORD CHART BOOK" />
      ...
      <div>
         <div class="panel panel-info">
            <div class="panel-heading text-center" style="background: #3f51b5;">
               <h1 style="font-size: 22px;color:#fff; text-shadow: 0px 0px;">GEETA MORNING PANEL CHART </h1>
            </div>
...
<tr>
   ...
   <td>3<br>4<br>8<br></td>
                     ...
                     $gh = mysqli_query($con, "SELECT * FROM panel where gameName = 'GEETA MORNING' ORDER BY id ");
