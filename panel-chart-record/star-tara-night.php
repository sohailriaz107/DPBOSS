...
<head>
   ...
   <title>STAR TARA NIGHT PANEL CHART RECORD MATKA BAZAR</title>
   <meta name="description" content="STAR TARA NIGHT PANEL CHART RECORD PATTI PANNA BAZAR 
PATTA STAR TARA NIGHT I CHART STAR TARA NIGHT OLD CHART RECORD STAR TARA NIGHT RESULTS RECORD STAR TARA NIGHT MATKA RECORD STAR TARA NIGHT MATKA TIPS CHART STAR TARA NIGHT HISTORY CHART STAR TARA NIGHT PANNA CHART STAR TARA NIGHT PATTI PATTA CHART ONLINE LIVE 
FIX NUMBER STAR TARA NIGHT MATKA RECORD CHART BOOK" />
      ...
      <div>
         <div class="panel panel-info">
            <div class="panel-heading text-center" style="background: #3f51b5;">
               <h1 style="font-size: 22px;color:#fff; text-shadow: 0px 0px;">STAR TARA NIGHT PANEL CHART </h1>
            </div>
...
<tr>
   ...
   <td class="r">2<br>8<br>9<br></td>
                     ...
                     $gh = mysqli_query($con, "SELECT * FROM panel where gameName = 'STAR TARA NIGHT' ORDER BY id ");
