...
<head>
   ...
   <title>TARA MORNING PANEL CHART RECORD MATKA BAZAR</title>
   <meta name="description" content="TARA MORNING PANEL CHART RECORD PATTI PANNA BAZAR 
PATTA TARA MORNING I CHART TARA MORNING OLD CHART RECORD TARA MORNING RESULTS RECORD TARA MORNING MATKA RECORD TARA MORNING MATKA TIPS CHART TARA MORNING HISTORY CHART TARA MORNING PANNA CHART TARA MORNING PATTI PATTA CHART ONLINE LIVE 
FIX NUMBER TARA MORNING MATKA RECORD CHART BOOK" />
      ...
      <div>
         <div class="panel panel-info">
            <div class="panel-heading text-center" style="background: #3f51b5;">
               <h1 style="font-size: 22px;color:#fff; text-shadow: 0px 0px;">TARA MORNING PANEL CHART </h1>
            </div>
