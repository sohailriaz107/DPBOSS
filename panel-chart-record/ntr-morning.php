...
<head>
   ...
   <title>NTR MORNING PANEL CHART RECORD MATKA BAZAR</title>
   <meta name="description" content="NTR MORNING PANEL CHART RECORD PATTI PANNA BAZAR 
PATTA NTR MORNING I CHART NTR MORNING OLD CHART RECORD NTR MORNING RESULTS RECORD NTR MORNING MATKA RECORD NTR MORNING MATKA TIPS CHART NTR MORNING HISTORY CHART NTR MORNING PANNA CHART NTR MORNING PATTI PATTA CHART ONLINE LIVE 
FIX NUMBER NTR MORNING MATKA RECORD CHART BOOK" />
      ...
      <div>
         <div class="panel panel-info">
            <div class="panel-heading text-center" style="background: #3f51b5;">
               <h1 style="font-size: 22px;color:#fff; text-shadow: 0px 0px;">NTR MORNING PANEL CHART </h1>
            </div>
...
<tr>
  ...
  <td>1<br>7<br>9<br></td>
                     ...
                     $gh = mysqli_query($con, "SELECT * FROM panel where gameName = 'NTR MORNING' ORDER BY id ");
