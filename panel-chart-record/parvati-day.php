...
<head>
   ...
   <title>PAVATI DAY PANEL CHART RECORD MATKA BAZAR</title>
   <meta name="description" content="PARVATI DAY PANEL CHART RECORD PATTI PANNA BAZAR 
PATTA PARVATI DAY I CHART PARVATI DAY OLD CHART RECORD PARVATI DAY RESULTS RECORD PARVATI DAY MATKA RECORD PARVATI DAY MATKA TIPS CHART PARVATI DAY HISTORY CHART PARVATI DAY PANNA CHART PARVATI DAY PATTI PATTA CHART ONLINE LIVE 
FIX NUMBER PARVATI DAY MATKA RECORD CHART BOOK" />
      ...
      <div>
         <div class="panel panel-info">
            <div class="panel-heading text-center" style="background: #3f51b5;">
               <h1 style="font-size: 22px;color:#fff; text-shadow: 0px 0px;">PARVATI DAY PANEL CHART </h1>
            </div>
...
<tr>
   ...
   <td class="">6<br>7<br>9</td>
                     ...
                     $gh = mysqli_query($con, "SELECT * FROM panel where gameName = 'PARVATI DAY' ORDER BY id ");
