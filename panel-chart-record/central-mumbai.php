...
<head>
   ...
   <title>CENTRAL MUMBAI PANEL CHART RECORD MATKA BAZAR</title>
   <meta name="description" content="CENTRAL MUMBAI PANEL CHART RECORD PATTI PANNA BAZAR 
PATTA CENTRAL MUMBAI I CHART CENTRAL MUMBAI OLD CHART RECORD CENTRAL MUMBAI RESULTS RECORD CENTRAL MUMBAI MATKA RECORD CENTRAL MUMBAI MATKA TIPS CHART CENTRAL MUMBAI HISTORY CHART CENTRAL MUMBAI PANNA CHART CENTRAL MUMBAI PATTI PATTA CHART ONLINE LIVE 
FIX NUMBER CENTRAL MUMBAI MATKA RECORD CHART BOOK" />
...
<body>
   ...
   <div>
   <?php 
$game_name = 'CENTRAL MUMBAI';
$game_name_hindi = 'सेंट्रल मुंबई';
...
?>
      ...
      <a href="#bottom" class="button2"> Go to Bottom </a>
         ...
         <div class="panel-heading text-center" style="background: #3f51b5;"><h3><?php echo $game_name;?> MATKA PANEL RECORD 2012 - <?php echo date('Y');?></h3></div>
...
<tr>
   ...
   <td>4<br>7<br>0</td>
                     ...
                     <?php
                     include '../config.php';
                     $gh = mysqli_query($con, "SELECT * FROM panel where gameName = 'CENTRAL MUMBAI' ORDER BY id ");
