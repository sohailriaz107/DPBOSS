...
<head>
   ...
   <title>KALYAN SRIDEVI NIGHT PANEL CHART RECORD MATKA BAZAR</title>
   <meta name="description" content="KALYAN SRIDEVI NIGHT PANEL CHART RECORD PATTI PANNA BAZAR 
PATTA KALYAN SRIDEVI NIGHT I CHART KALYAN SRIDEVI NIGHT OLD CHART RECORD KALYAN SRIDEVI NIGHT RESULTS RECORD KALYAN SRIDEVI NIGHT MATKA RECORD KALYAN SRIDEVI NIGHT MATKA TIPS CHART KALYAN SRIDEVI NIGHT HISTORY CHART KALYAN SRIDEVI NIGHT PANNA CHART KALYAN SRIDEVI NIGHT PATTI PATTA CHART ONLINE LIVE 
FIX NUMBER KALYAN SRIDEVI NIGHT MATKA RECORD CHART BOOK" />
      ...
      <div>
         <div class="panel panel-info">
            <div class="panel-heading text-center" style="background: #3f51b5;">
               <h1 style="font-size: 22px;color:#fff; text-shadow: 0px 0px;">KALYAN SRIDEVI NIGHT PANEL CHART </h1>
            </div>
            <div class="panel-body">
               <table style="width: 100%; text-align:center;" class="panel-chart chart-table" cellpadding="2">
                  ...
                  <tbody>
                     ...
                     <?php
                     include '../config.php';
                     $gh = mysqli_query($con, "SELECT * FROM panel where gameName = 'KALYAN SRIDEVI NIGHT' ORDER BY id ");
