...
<title>MUMBAI PAREL PENAL PANEL CHART RECORD MATKA BAZAR</title> <meta name="description" content="MUMBAI PAREL MATKA PENAL PANEL CHART RECORD PANNA PATTI 
PATTA RECORD  BAZAR RESULTS RECORD  MATKA RECORD  MATKA TIPS CHART  BAZAR HISTORY CHART  PANNA CHART  PATTI PATTA CHART ONLINE 
LIVE FIX NUMBER BAZAR MUMBAI PAREL  MATKA RECORD CHART BOOK"/>
<link rel="canonical" href="https://dpboss.boston/panel-chart-record/mumbai-parel.php">
...
<div class="panel-heading text-center" style="background: #3f51b5;"><h1  style="font-size: 22px;color:#fff; text-shadow: 0px 0px;">MUMBAI PAREL PANEL CHART</h1></div>
...
<?php 
include '../config.php';
$gh = mysqli_query($con,"SELECT * FROM panel where gameName = 'MUMBAI PAREL' ORDER BY id ");
