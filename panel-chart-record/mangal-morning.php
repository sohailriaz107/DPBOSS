...
<head>
   ...
   <title>MANGAL MORNING PANEL CHART RECORD MATKA BAZAR</title>
   <meta name="description" content="MANGAL MORNING PANEL CHART RECORD PATTI PANNA BAZAR 
PATTA MANGAL MORNING I CHART MANGAL MORNING OLD CHART RECORD MANGAL MORNING RESULTS RECORD MANGAL MORNING MATKA RECORD MANGAL MORNING MATKA TIPS CHART MANGAL MORNING HISTORY CHART MANGAL MORNING PANNA CHART MANGAL MORNING PATTI PATTA CHART ONLINE LIVE 
FIX NUMBER MANGAL MORNING MATKA RECORD CHART BOOK" />
      ...
      <div>
         <div class="panel panel-info">
            <div class="panel-heading text-center" style="background: #3f51b5;">
               <h1 style="font-size: 22px;color:#fff; text-shadow: 0px 0px;">MANGAL MORNING PANEL CHART </h1>
            </div>
...
<tr>
   ...
   <td>2<br>2<br>0</td>
                     ...
                     $gh = mysqli_query($con, "SELECT * FROM panel where gameName = 'MANGAL MORNING' ORDER BY id ");
