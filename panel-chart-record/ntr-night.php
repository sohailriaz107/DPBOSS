...
<head>
   ...
   <title>PNTR NIGHT PANEL CHART RECORD MATKA BAZAR</title>
   <meta name="description" content="NTR NIGHT PANEL CHART RECORD PATTI PANNA BAZAR 
PATTA NTR NIGHT I CHART NTR NIGHT OLD CHART RECORD NTR NIGHT RESULTS RECORD NTR NIGHT MATKA RECORD NTR NIGHT MATKA TIPS CHART NTR NIGHT HISTORY CHART NTR NIGHT PANNA CHART NTR NIGHT PATTI PATTA CHART ONLINE LIVE 
FIX NUMBER NTR NIGHT MATKA RECORD CHART BOOK" />
      ...
      <div>
         <div class="panel panel-info">
            <div class="panel-heading text-center" style="background: #3f51b5;">
               <h1 style="font-size: 22px;color:#fff; text-shadow: 0px 0px;">NTR NIGHT PANEL CHART </h1>
            </div>
...
<tr>
  ...
  <td>2<br>3<br>4<br></td>
                     ...
                     $gh = mysqli_query($con, "SELECT * FROM panel where gameName = 'NTR NIGHT' ORDER BY id ");
