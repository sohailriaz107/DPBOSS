...
<head>
   ...
   <title>DILKUSH PANEL CHART RECORD MATKA BAZAR</title>
   <meta name="description" content="DILKUSH PANEL CHART RECORD PATTI PANNA BAZAR 
PATTA DILKUSH I CHART DILKUSH OLD CHART RECORD DILKUSH RESULTS RECORD DILKUSH MATKA RECORD DILKUSH MATKA TIPS CHART DILKUSH HISTORY CHART DILKUSH PANNA CHART DILKUSH PATTI PATTA CHART ONLINE LIVE 
FIX NUMBER DILKUSH MATKA RECORD CHART BOOK" />
      ...
      <div>
         <div class="panel panel-info">
            <div class="panel-heading text-center" style="background: #3f51b5;">
               <h1 style="font-size: 22px;color:#fff; text-shadow: 0px 0px;">DILKUSH PANEL CHART </h1>
            </div>
...
<tr>
   ...
   <td class="">1<br>5<br>0</td>
                     ...
                     $gh = mysqli_query($con, "SELECT * FROM panel where gameName = 'DILKUSH' ORDER BY id ");
