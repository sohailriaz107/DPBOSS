...
<title>TIRTHA DAY PENAL PANEL CHART RECORD MATKA BAZAR</title> <meta name="description" content="TIRTHA DAY MATKA PENAL PANEL CHART RECORD PANNA PATTI 
...
<link rel="canonical" href="https://dpboss.boston/panel-chart-record/tirtha-day.php">
...
<div class="panel-heading text-center"><h1  style="font-size: 22px;color:#fff; text-shadow: 0px 0px;">TIRTHA DAY Panel Chart </h1></div>
...
<?php 
include '../config.php';
$gh = mysqli_query($con,"SELECT * FROM panel where gameName = 'TIRTHA DAY' ORDER BY id ");
