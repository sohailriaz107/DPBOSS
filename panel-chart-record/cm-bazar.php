...
<title>CM BAZAR PENAL PANEL CHART RECORD MATKA BAZAR</title> <meta name="description" content="CM BAZAR PENAL PANEL CHART RECORD PATTI PANNA BAZAR 
PATTA CM BAZARI CHART CM BAZAR OLD CHART RECORD CM BAZAR RESULTS RECORD CM BAZAR MATKA RECORD CM BAZAR MATKA TIPS CHART CM BAZAR HISTORY CHART CM BAZAR PANNA CHART CM BAZAR PATTI PATTA CHART ONLINE LIVE 
FIX NUMBER CM BAZAR MATKA RECORD CHART BOOK"/> 
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="viewport" content="width=device-width, initial-scale=1">
<link rel="canonical" href="https://dpboss.boston/panel-chart-record/cm-bazar.php">
...
<div class="panel-heading text-center" style="background: #3f51b5;"><h1  style="font-size: 22px;color:#fff; text-shadow: 0px 0px;">CM BAZAR PANEL CHART </h1></div>
...
<?php 
include '../config.php';
$gh = mysqli_query($con,"SELECT * FROM panel where gameName = 'CM BAZAR' ORDER BY id ");
