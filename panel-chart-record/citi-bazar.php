...
<head>
   ...
   <title>CITI BAZAR PANEL CHART RECORD MATKA BAZAR</title>
   <meta name="description" content="CITI BAZAR PANEL CHART RECORD PATTI PANNA BAZAR 
PATTA CITI BAZAR I CHART CITI BAZAR OLD CHART RECORD CITI BAZAR RESULTS RECORD CITI BAZAR MATKA RECORD CITI BAZAR MATKA TIPS CHART CITI BAZAR HISTORY CHART CITI BAZAR PANNA CHART CITI BAZAR PATTI PATTA CHART ONLINE LIVE 
FIX NUMBER CITI BAZAR MATKA RECORD CHART BOOK" />
      ...
      <div>
         <div class="panel panel-info">
            <div class="panel-heading text-center" style="background: #3f51b5;">
               <h1 style="font-size: 22px;color:#fff; text-shadow: 0px 0px;">CITI BAZAR PANEL CHART </h1>
            </div>
...
<tr>
   ...
   <td class="r">1<br>3<br>6</td>
                     ...
                     $gh = mysqli_query($con, "SELECT * FROM panel where gameName = 'CITI BAZAR' ORDER BY id ");
