...
<title>KESARI PANEL CHART RECORD MATKA BAZAR</title> <meta name="description" content="KESARI PENAL PANEL CHART RECORD PATTI PANNA BAZAR 
PATTA KESARII CHART KESARI OLD CHART RECORD KESARI RESULTS RECORD KESARI MATKA RECORD KESARI MATKA TIPS CHART KESARI HISTORY CHART KESARI PANNA CHART KESARI PATTI PATTA CHART ONLINE LIVE 
FIX NUMBER KESARI MATKA RECORD CHART BOOK"/> 
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="viewport" content="width=device-width, initial-scale=1">
<link rel="canonical" href="https://dpboss.boston/panel-chart-record/kesari.php">
...
<div class="panel-heading text-center" style="background: #3f51b5;"><h1  style="font-size: 22px;color:#fff; text-shadow: 0px 0px;">KESARI PANEL CHART </h1></div>
...
<?php 
include '../config.php';
$gh = mysqli_query($con,"SELECT * FROM panel where gameName = 'KESARI' ORDER BY id ");
