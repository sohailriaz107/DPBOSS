...
<title>DELHI DAY PENAL PANEL CHART RECORD MATKA BAZAR</title> <meta name="description" content="DELHI DAY  MATKA PENAL PANEL CHART RECORD PANNA PATTI 
...
<link rel="canonical" href="https://dpboss.boston/panel-chart-record/delhi-day.php"/>
...
<div class="panel-heading text-center" style="background: #3f51b5;"><h1  style="font-size: 22px;color:#fff; text-shadow: 0px 0px;">DELHI DAY Panel Chart </h1></div>

<div class="pnl-chart-div">
    <h2 class="pnl-chart-h">Navigating through the DELHI DAY Panel Chart</h2>
    <p class="pnl-chart-p">Welcome to the DELHI DAY Panel Chart. This is yet another chart from the DELHI DAY Market and it represents the result in the form of panels. You can see the data below and you can check out your result very easily. If you have played the game anyway after Feb 2021 and till today’s date, then this chart has everything for you.</p>
...
<?php 
include '../config.php';
$gh = mysqli_query($con,"SELECT * FROM panel where gameName = 'DELHI DAY' ORDER BY id ");
