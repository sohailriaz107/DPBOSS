...
<head>
   ...
   <title>MAIN DAY PANEL CHART RECORD MATKA BAZAR</title>
   <meta name="description" content="MAIN DAY PANEL CHART RECORD PATTI PANNA BAZAR 
PATTA MAIN DAY I CHART MAIN DAY OLD CHART RECORD MAIN DAY RESULTS RECORD MAIN DAY MATKA RECORD MAIN DAY MATKA TIPS CHART MAIN DAY HISTORY CHART MAIN DAY PANNA CHART MAIN DAY PATTI PATTA CHART ONLINE LIVE 
FIX NUMBER MAIN DAY MATKA RECORD CHART BOOK" />
      ...
      <div>
         <div class="panel panel-info">
            <div class="panel-heading text-center" style="background: #3f51b5;">
               <h1 style="font-size: 22px;color:#fff; text-shadow: 0px 0px;">MAIN DAY PANEL CHART </h1>
            </div>
