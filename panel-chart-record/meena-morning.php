...
<head>
   ...
   <title>MEENA MORNING PANEL CHART RECORD MATKA BAZAR</title>
   <meta name="description" content="MEENA MORNING PANEL CHART RECORD PATTI PANNA BAZAR 
PATTA MEENA MORNING I CHART MEENA MORNING OLD CHART RECORD MEENA MORNING RESULTS RECORD MEENA MORNING MATKA RECORD MEENA MORNING MATKA TIPS CHART MEENA MORNING HISTORY CHART MEENA MORNING PANNA CHART MEENA MORNING PATTI PATTA CHART ONLINE LIVE 
FIX NUMBER MEENA MORNING MATKA RECORD CHART BOOK" />
      ...
      <div>
         <div class="panel panel-info">
            <div class="panel-heading text-center" style="background: #3f51b5;">
               <h1 style="font-size: 22px;color:#fff; text-shadow: 0px 0px;">MEENA MORNING PANEL CHART </h1>
            </div>
...
<tr>
   ...
   <td>3<br>6<br>8<br></td>
                     ...
                     $gh = mysqli_query($con, "SELECT * FROM panel where gameName = 'MEENA MORNING' ORDER BY id ");
