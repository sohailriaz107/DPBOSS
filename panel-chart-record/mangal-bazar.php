...
<head>
   ...
   <title>MANGAL BAZAR PANEL CHART RECORD MATKA BAZAR</title>
   <meta name="description" content="MANGAL BAZAR PANEL CHART RECORD PATTI PANNA BAZAR 
PATTA MANGAL BAZAR I CHART MANGAL BAZAR OLD CHART RECORD MANGAL BAZAR RESULTS RECORD MANGAL BAZAR MATKA RECORD MANGAL BAZAR MATKA TIPS CHART MANGAL BAZAR HISTORY CHART MANGAL BAZAR PANNA CHART MANGAL BAZAR PATTI PATTA CHART ONLINE LIVE 
FIX NUMBER MANGAL BAZAR MATKA RECORD CHART BOOK" />
...
<?php 
   ...
   if($_SERVER['HTTP_HOST'] == 'dpboss.boston' || $_SERVER['HTTP_HOST'] == 'spbosss.com'){
      ...
      <div>
         <div class="panel panel-info">
            <div class="panel-heading text-center" style="background: #3f51b5;">
               <h1 style="font-size: 22px;color:#fff; text-shadow: 0px 0px;">MANGAL BAZAR PANEL CHART </h1>
            </div>
...
<tr>
   ...
   <td>2<br>4<br>8</td>
                     ...
                     $gh = mysqli_query($con, "SELECT * FROM panel where gameName = 'MANGAL BAZAR' ORDER BY id ");
