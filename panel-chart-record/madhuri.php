...
<title>Madhuri Panel Chart | Madhuri Online Record</title>
<meta name="description" content="We provide our visitors with the latest results, updates, and Satta Matka tips, you can get the complete Madhuri Panel Chart with live and recorded data.">
<meta name="keywords" content="Madhuri panel chart, Madhuri panel chart, Madhuri patti chart, Madhuri panel record, Madhuri panel record, Madhuri pana chart">
<link rel="canonical" href="https://dpboss.boston/panel-chart-record/madhuri.php"/>
...
<?php 
include '../config.php';
$gh = mysqli_query($con,"SELECT * FROM panel where gameName = 'MADHURI' ORDER BY id ");
