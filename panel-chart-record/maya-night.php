...
<head>
   ...
   <title>MAYA NIGHT PANEL CHART RECORD MATKA BAZAR</title>
   <meta name="description" content="MAYA NIGHT PANEL CHART RECORD PATTI PANNA BAZAR 
PATTA MAYA NIGHT I CHART MAYA NIGHT OLD CHART RECORD MAYA NIGHT RESULTS RECORD MAYA NIGHT MATKA RECORD MAYA NIGHT MATKA TIPS CHART MAYA NIGHT HISTORY CHART MAYA NIGHT PANNA CHART MAYA NIGHT PATTI PATTA CHART ONLINE LIVE 
FIX NUMBER MAYA NIGHT MATKA RECORD CHART BOOK" />
      ...
      <div>
         <div class="panel panel-info">
            <div class="panel-heading text-center" style="background: #3f51b5;">
               <h1 style="font-size: 22px;color:#fff; text-shadow: 0px 0px;">MAYA NIGHT PANEL CHART </h1>
            </div>
...
<tr>
   ...
   <td>2<br>9<br>0</td>
                     ...
                     $gh = mysqli_query($con, "SELECT * FROM panel where gameName = 'MAYA NIGHT' ORDER BY id ");
