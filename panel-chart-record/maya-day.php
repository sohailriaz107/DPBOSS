...
<head>
   ...
   <title>MAYA DAY PANEL CHART RECORD MATKA BAZAR</title>
   <meta name="description" content="MAYA DAY PANEL CHART RECORD PATTI PANNA BAZAR 
PATTA MAYA DAY I CHART MAYA DAY OLD CHART RECORD MAYA DAY RESULTS RECORD MAYA DAY MATKA RECORD MAYA DAY MATKA TIPS CHART MAYA DAY HISTORY CHART MAYA DAY PANNA CHART MAYA DAY PATTI PATTA CHART ONLINE LIVE 
FIX NUMBER MAYA DAY MATKA RECORD CHART BOOK" />
      ...
      <div>
         <div class="panel panel-info">
            <div class="panel-heading text-center" style="background: #3f51b5;">
               <h1 style="font-size: 22px;color:#fff; text-shadow: 0px 0px;">MAYA DAY PANEL CHART </h1>
            </div>
...
<tr>
   ...
   <td class="">1<br>3<br>0</td>
                     ...
                     $gh = mysqli_query($con, "SELECT * FROM panel where gameName = 'MAYA DAY' ORDER BY id ");
