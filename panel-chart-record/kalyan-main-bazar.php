...
<head>
   ...
   <title>KALYAN MAIN BAZAR PANEL CHART RECORD MATKA BAZAR</title>
   <meta name="description" content="KALYAN MAIN BAZAR PANEL CHART RECORD PATTI PANNA BAZAR 
PATTA KALYAN MAIN BAZAR I CHART KALYAN MAIN BAZAR OLD CHART RECORD KALYAN MAIN BAZAR RESULTS RECORD KALYAN MAIN BAZAR MATKA RECORD KALYAN MAIN BAZAR MATKA TIPS CHART KALYAN MAIN BAZAR HISTORY CHART KALYAN MAIN BAZAR PANNA CHART KALYAN MAIN BAZAR PATTI PATTA CHART ONLINE LIVE 
FIX NUMBER KALYAN MAIN BAZAR MATKA RECORD CHART BOOK" />
      ...
      <div>
         <div class="panel panel-info">
            <div class="panel-heading text-center" style="background: #3f51b5;">
               <h1 style="font-size: 22px;color:#fff; text-shadow: 0px 0px;">KALYAN MAIN BAZAR PANEL CHART </h1>
            </div>
            <div class="panel-body">
               <table style="width: 100%; text-align:center;" class="panel-chart chart-table" cellpadding="2">
                  ...
                  <tbody>
                     ...
                     <?php
                     include '../config.php';
                     $gh = mysqli_query($con, "SELECT * FROM panel where gameName = 'KALYAN MAIN BAZAR' ORDER BY id ");
