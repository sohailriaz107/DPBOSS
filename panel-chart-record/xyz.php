...
<head>
   ...
   <title>XYZ PANEL CHART RECORD MATKA BAZAR</title>
   <meta name="description" content="XYZ PANEL CHART RECORD PATTI PANNA BAZAR 
PATTA XYZ I CHART XYZ OLD CHART RECORD XYZ RESULTS RECORD XYZ MATKA RECORD XYZ MATKA TIPS CHART XYZ HISTORY CHART XYZ PANNA CHART XYZ PATTI PATTA CHART ONLINE LIVE 
FIX NUMBER XYZ MATKA RECORD CHART BOOK" />
      ...
      <div>
         <div class="panel panel-info">
            <div class="panel-heading text-center" style="background: #3f51b5;">
               <h1 style="font-size: 22px;color:#fff; text-shadow: 0px 0px;">XYZ PANEL CHART </h1>
            </div>
...
<tr>
   ...
   <td class="">3<br>4<br>9</td>
                     ...
                     $gh = mysqli_query($con, "SELECT * FROM panel where gameName = 'XYZ' ORDER BY id ");
