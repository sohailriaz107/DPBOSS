...
<title>CENTRAL BAZAR PENAL PANEL CHART RECORD MATKA BAZAR</title> <meta name="description" content="CENTRAL BAZAR PENAL PANEL CHART RECORD PATTI PANNA BAZAR 
PATTA CENTRAL BAZARI CHART CENTRAL BAZAR OLD CHART RECORD CENTRAL BAZAR RESULTS RECORD CENTRAL BAZAR MATKA RECORD CENTRAL BAZAR MATKA TIPS CHART CENTRAL BAZAR HISTORY CHART CENTRAL BAZAR PANNA CHART CENTRAL BAZAR PATTI PATTA CHART ONLINE LIVE 
FIX NUMBER CENTRAL BAZAR MATKA RECORD CHART BOOK"/> 
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="viewport" content="width=device-width, initial-scale=1">
<link rel="canonical" href="https://dpboss.boston/panel-chart-record/central-bazar.php">
...
<div class="panel-heading text-center" style="background: #3f51b5;"><h1  style="font-size: 22px;color:#fff; text-shadow: 0px 0px;">CENTRAL BAZAR PANEL CHART </h1></div>
...
<?php 
include '../config.php';
$gh = mysqli_query($con,"SELECT * FROM panel where gameName = 'CENTRAL BAZAR' ORDER BY id ");
