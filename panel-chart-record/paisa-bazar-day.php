...
<title>PAISA BAZAR DAY PENAL PANEL CHART RECORD MATKA BAZAR</title> <meta name="description" content="PAISA BAZAR DAY MATKA PENAL PANEL CHART RECORD PANNA PATTI 
...
<link rel="canonical" href="https://dpboss.boston/panel-chart-record/paisa-bazar-day.php">
...
<div class="panel-heading text-center" style="background: #3f51b5;"><h1  style="font-size: 22px;color:#fff; text-shadow: 0px 0px;">PAISA BAZAR DAY Panel Chart </h1></div>
...
<?php 
include '../config.php';
$gh = mysqli_query($con,"SELECT * FROM panel where gameName = 'PAISA BAZAR DAY' ORDER BY id ");
