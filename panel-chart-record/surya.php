...
<title>SURYA PENAL PANEL CHART RECORD MATKA BAZAR</title> <meta name="description" content="SURYA PENAL PANEL CHART RECORD PATTI PANNA BAZAR 
PATTA SURYAI CHART SURYA OLD CHART RECORD SURYA RESULTS RECORD SURYA MATKA RECORD SURYA MATKA TIPS CHART SURYA HISTORY CHART SURYA PANNA CHART SURYA PATTI PATTA CHART ONLINE LIVE 
FIX NUMBER SURYA MATKA RECORD CHART BOOK"/> 
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="viewport" content="width=device-width, initial-scale=1">
<link rel="canonical" href="https://dpboss.boston/panel-chart-record/surya.php">
...
<div class="panel-heading text-center" style="background: #3f51b5;"><h1  style="font-size: 22px;color:#fff; text-shadow: 0px 0px;">SURYA PANEL CHART </h1></div>
...
<?php 
include '../config.php';
$gh = mysqli_query($con,"SELECT * FROM panel where gameName = 'SURYA' ORDER BY id ");
