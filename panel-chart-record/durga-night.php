...
<head>
   ...
   <title>DURGA NIGHT PANEL CHART RECORD MATKA BAZAR</title>
   <meta name="description" content="DURGA NIGHT PANEL CHART RECORD PATTI PANNA BAZAR 
PATTA DURGA NIGHT I CHART DURGA NIGHT OLD CHART RECORD DURGA NIGHT RESULTS RECORD DURGA NIGHT MATKA RECORD DURGA NIGHT MATKA TIPS CHART DURGA NIGHT HISTORY CHART DURGA NIGHT PANNA CHART DURGA NIGHT PATTI PATTA CHART ONLINE LIVE 
FIX NUMBER DURGA NIGHT MATKA RECORD CHART BOOK" />
      ...
      <div>
         <div class="panel panel-info">
            <div class="panel-heading text-center" style="background: #3f51b5;">
               <h1 style="font-size: 22px;color:#fff; text-shadow: 0px 0px;">DURGA NIGHT PANEL CHART </h1>
            </div>
...
<tr>
   ...
   <td class="">1<br>6<br>9</td>
                     ...
                     $gh = mysqli_query($con, "SELECT * FROM panel where gameName = 'DURGA NIGHT' ORDER BY id ");
