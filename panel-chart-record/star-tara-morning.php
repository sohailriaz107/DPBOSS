...
<head>
   ...
   <title>STAR TARA MORNING PANEL CHART RECORD MATKA BAZAR</title>
   <meta name="description" content="STAR TARA MORNING PANEL CHART RECORD PATTI PANNA BAZAR 
PATTA STAR TARA MORNING I CHART STAR TARA MORNING OLD CHART RECORD STAR TARA MORNING RESULTS RECORD STAR TARA MORNING MATKA RECORD STAR TARA MORNING MATKA TIPS CHART STAR TARA MORNING HISTORY CHART STAR TARA MORNING PANNA CHART STAR TARA MORNING PATTI PATTA CHART ONLINE LIVE 
FIX NUMBER STAR TARA MORNING MATKA RECORD CHART BOOK" />
      ...
      <div>
         <div class="panel panel-info">
            <div class="panel-heading text-center" style="background: #3f51b5;">
               <h1 style="font-size: 22px;color:#fff; text-shadow: 0px 0px;">STAR TARA MORNING PANEL CHART </h1>
            </div>
...
<tr>
   ...
   <td class="r">0<br>0<br>0<br></td>
                     ...
                     $gh = mysqli_query($con, "SELECT * FROM panel where gameName = 'STAR TARA MORNING' ORDER BY id ");
