...
<head>
   ...
   <title>KALYAN NIGHT BAZAR PANEL CHART RECORD MATKA BAZAR</title>
   <meta name="description" content="KALYAN NIGHT BAZAR PANEL CHART RECORD PATTI PANNA BAZAR 
PATTA KALYAN NIGHT BAZAR I CHART KALYAN NIGHT BAZAR OLD CHART RECORD KALYAN NIGHT BAZAR RESULTS RECORD KALYAN NIGHT BAZAR MATKA RECORD KALYAN NIGHT BAZAR MATKA TIPS CHART KALYAN NIGHT BAZAR HISTORY CHART KALYAN NIGHT BAZAR PANNA CHART KALYAN NIGHT BAZAR PATTI PATTA CHART ONLINE LIVE 
FIX NUMBER KALYAN NIGHT BAZAR MATKA RECORD CHART BOOK" />
...
<?php 
      ...
      <div>
         <div class="panel panel-info">
            <div class="panel-heading text-center" style="background: #3f51b5;">
               <h1 style="font-size: 22px;color:#fff; text-shadow: 0px 0px;">KALYAN NIGHT BAZAR PANEL CHART </h1>
            </div>
   ...
   <tr>
      ...
      <td class="r">*<br>*<br>*</td>
                     ...
                     $gh = mysqli_query($con, "SELECT * FROM panel where gameName = 'KALYAN NIGHT BAZAR' ORDER BY id ");
