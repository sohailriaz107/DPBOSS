...
<head>
   ...
   <title>RAJDHANI MORNING MAIN PANEL CHART RECORD MATKA BAZAR</title>
   <meta name="description" content="RAJDHANI MORNING [main] PANEL CHART RECORD PATTI PANNA BAZAR 
PATTA RAJDHANI MORNING [main] I CHART RAJDHANI MORNING [main] OLD CHART RECORD RAJDHANI MORNING [main] RESULTS RECORD RAJDHANI MORNING [main] MATKA RECORD RAJDHANI MORNING [main] MATKA TIPS CHART RAJDHANI MORNING [main] HISTORY CHART RAJDHANI MORNING [main] PANNA CHART RAJDHANI MORNING [main] PATTI PATTA CHART ONLINE LIVE 
FIX NUMBER RAJDHANI MORNING [main] MATKA RECORD CHART BOOK" />
...
<tr>
   ...
   <td>2<br>6<br>7</td>
                     ...
                     <?php
                     include '../config.php';
                     $gh = mysqli_query($con, "SELECT * FROM panel where gameName = 'RAJDHANI MORNING [main]' ORDER BY id ");
